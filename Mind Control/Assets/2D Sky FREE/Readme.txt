...
------------------------------------------------------------------
	...
	Note:
		...
		• This package is free version of 2D Sky. See full version links below.
		• This package contains low quality textures which just good enough for mobiles games.
